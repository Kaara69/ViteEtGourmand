            ...
            <div>
                <h4 class="fw-bold mb-1">
                    📊 Statistiques &amp; Chiffre d'affaires
                        <span class="nosql-badge ms-2">MongoDB</span>
                </h4>
                <p class="text-muted small mb-0">
                    Les statistiques sont stockées dans une base de données <strong>MongoDB</strong>,
                    indépendante de la base <strong>MySQL</strong> utilisée pour les données transactionnelles.
                </p>
            </div>
